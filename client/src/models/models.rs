...
#[derive(Deserialize, Debug)]
pub struct EmbeddedCategoryItems {
    pub items: Vec<CategoryItemWrapper>,
}

#[derive(Deserialize, Debug)]
pub struct CategoryItemWrapper {
    pub category: Category,
}

#[derive(Deserialize, Debug)]
pub struct CategoryRootWrapper {
    pub category: Category,
    #[serde(rename = "_links")]
    pub links: Option<HalCategoryLinks>,
}
